...
class HFImageClassifier(nn.Module):
    ...
    def from_pretrained(
        ...
        net = transformers.AutoModelForImageClassification.from_pretrained(model_name)
    ...
    def forward(
        ...
        *,
        ...
        outputs = self.net(pixel_values=pixel_values, labels=labels)  # ty:ignore[call-non-callable]
