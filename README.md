...
# serious, adjust --nproc_per_node, -b, and -j depending on your system
OMP_NUM_THREADS=1 torchrun --standalone --nproc_per_node=4 -m crepa finetune -a ijepa_vith14_1k -j 32 -b 1024 --epochs 2 --lr 3e-4 --log-freq 1 2>&1 | tee logs/finetune/ijepa.log
